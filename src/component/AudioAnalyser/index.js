...
class AudioAnalyser extends Component {
    ...
    static renderProps = ["status", "audioSrc","recordedResult"]
    ...
    render() {
        const {
            children, className, audioSrc,recordedResult
        } = this.props;
        
        console.log("recordedResult" , recordedResult);
        return (
                  ...
                  <div>
                      <audio controls src={audioSrc} id={audioSrc.substring(audioSrc.length - 6)}/>
                        ...
                        <h2>Result</h2>
                        {
                            ...
                            recordedResult && recordedResult.map(record=>(
                                <audio controls src={record} id={record.substring(audioSrc.length - 6)}/>
                            ))
                        }
